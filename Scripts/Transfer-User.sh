...
#Determinar usuario con la sesión activa.
...
result="/Users/$origen existe" echo "<result>$result</result>"
else echo "<result>/Users/$origen no existe. Deteniendo.</result>"
exit 1
fi
if [ -d "/Users/$destino" ]; then 
result="/Users/$destino existe" echo "<result>$result</result>"
else echo "<result>/Users/$destino no existe. Deteniendo.</result>"
exit 1
fi

# Renombrar Directorio Destino
mv /Users/$destino /Users/$destino-antes
echo "Renombrado /Users/$destino a /Users/$destino-antes"
# Renombrar directorio de origen
mv /Users/$origen /Users/$destino
echo "Renombrado /Users/$origen to /Users/$destino"
